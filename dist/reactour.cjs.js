...
var Guide = styled__default.div(_templateObject$4(), function (props) {
  ...
  var pos = function pos(helperPosition) {
    ...
    var coords = {
      ...
      centerBottom: [targetLeft + (targetRight - targetLeft) / 2 - helperWidth / 2 - padding * 2, targetBottom + padding * 2]
    };
...
var propTypes = {
  ...
  steps: PropTypes.arrayOf(PropTypes.shape({
    ...
    position: PropTypes.oneOfType([PropTypes.arrayOf(PropTypes.number), PropTypes.oneOf(['top', 'right', 'bottom', 'left', 'center', 'centerBottom'])]),
